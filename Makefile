...
SDL_INCS = 
SDL_LIBS = -lSDL -lSDL_image -lSDL_gfx -lSDL_ttf
...
OPENCV_INCS = -I/usr/include/opencv
...
INC = $(GL_INCS) $(SDL_INCS) $(ONION_INCS) $(OPENCV_INCS) $(MMAL_INCS) -Isrc -I/usr/local/include
CFLAGS = -Wall -pg `sdl-config --cflags` -fpermissive
RESINC =
